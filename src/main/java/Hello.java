...
public class Hello {
  ...
  public static void main(String... args) throws IOException {
    ...
    LDUser user = new LDUser.Builder("sally")
                            .name("sally")
                            .build();
    ...
    LDUser emptyUser = new LDUser("");
    
    flagValue = client.boolVariation(FEATURE_FLAG_KEY, emptyUser, false);    

    showMessage("Feature flag '" + FEATURE_FLAG_KEY + "' is " + flagValue + " for empty user");
